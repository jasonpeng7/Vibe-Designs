  ...
  return (
    <>
      <SEO
        ...
        description="Review the Terms of Service for ViBE Design before using our website or services."
      />
      <div className="bg-background text-foreground min-h-screen py-20">
        <div className="container mx-auto max-w-4xl px-4">
          <h1 className="text-4xl font-bold mb-8 hero-text">
            Terms of Service
          </h1>
          ...
          <div className="space-y-8 text-muted-foreground">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  You must not attempt to disrupt or interfere with the
                  security, functionality, or content of the site.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  You retain ownership of any content you provide to us for use
                  in your project.
                </li>
              </ul>
            </section>
